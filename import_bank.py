...
DEFAULT_RULES = {
    "revenue_rules": [
        ...
        {"keyword": "エートラック", "business": "A-TRUCK", "note": "A-TRUCK報酬"},
        {"keyword": "オザワ", "business": "共通", "note": "個人振込"},
        {"keyword": "サンケン", "business": "オフィスVONDS", "note": "SANKENクライアント報酬"},
        {"keyword": "SANKEN", "business": "オフィスVONDS", "note": "SANKENクライアント報酬"},
        {"keyword": "マサムネ", "business": "UNLYUTO", "note": "デリヘル法人"},
        {"keyword": "ネクストエイド", "business": "共通", "note": "保険代理店"},
        {"keyword": "NTT", "business": "共通", "note": "保険代理店経由"},
    ...
    "expense_rules": [
        ...
        {"keyword": "振込手数料", "category": "振込手数料", "business": "共通"},
        {"keyword": "損害保険ジャパン", "category": "自動車保険", "business": "オフィスVONDS"},
        {"keyword": "損保ジャパン", "category": "自動車保険", "business": "オフィスVONDS"},
        {"keyword": "ヤチンシュウノウ", "category": "家賃", "business": "オフィスVONDS"},
        {"keyword": "サイバーリンク", "category": "ツール費用", "business": "共通"},
        {"keyword": "ソンポビマワリ", "category": "保険料（解約済）", "business": "共通"},
        {"keyword": "SOMPO", "category": "保険料（解約済）", "business": "共通"},
        {"keyword": "SEOキョウカイ", "category": "会費", "business": "オフィスVONDS"},
        {"keyword": "KARAKUBUY", "category": "海外通販", "business": "共通"},
        {"keyword": "MICROSOFT", "category": "ツール費用", "business": "共通"},
        {"keyword": "EVERAI", "category": "ツール費用", "business": "共通"},
        {"keyword": "DREAM STUDIO", "category": "ツール費用", "business": "共通"},
        {"keyword": "PADDLE", "category": "ツール費用", "business": "共通"},
        {"keyword": "CHATAI", "category": "ツール費用", "business": "共通"},
        {"keyword": "FIGMA", "category": "ツール費用", "business": "共通"},
        {"keyword": "ココナラ", "category": "外注費", "business": "共通"},
        {"keyword": "MHF", "category": "家賃", "business": "オフィスVONDS"},
        {"keyword": "損害保険", "category": "自動車保険", "business": "オフィスVONDS"},
        {"keyword": "振込手数", "category": "振込手数料", "business": "共通"},
        {"keyword": "イオネセイキュウ", "category": "カード決済", "business": "共通"},
        ...
        {"keyword": "イオネセイキュウ", "category": "光熱費・通信費", "business": "共通"},
        {"keyword": "ネットフリックス", "category": "娯楽費", "business": "共通"},
        {"keyword": "NETFLIX", "category": "娯楽費", "business": "共通"},
        {"keyword": "UBER", "category": "食費", "business": "共通"},
        {"keyword": "ラクテン", "category": "消耗品", "business": "共通"},
        {"keyword": "楽天", "category": "消耗品", "business": "共通"},
        {"keyword": "NETLIFY", "category": "サーバー代", "business": "オフィスVONDS"},
        {"keyword": "CSS", "category": "保険料（解約済）", "business": "共通"},
        {"keyword": "NSS", "category": "会費", "business": "オフィスVONDS"},
        {"keyword": "クール", "category": "不明", "business": "共通"},
        {"keyword": "ナナマイ", "category": "不明", "business": "共通"},
        {"keyword": "キキカワ", "category": "不明", "business": "共通"},
