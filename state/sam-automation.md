...
- [x] **絆JOB画像流し込み Phase 1**（2026-04-18 サム実行）
  - 17枚をWPメディアライブラリへ投入・9固定ページ強化完了
  - 詳細: `session-logs/2026-04-18_1625_kizuna-job-image-injection.md`
- [ ] **絆JOB Phase 2**: home (ID 90) 対応 / 残素材の配置計画 / 動画対応
  - home はテーマ描画依存・テーマファイル編集 or ウィジェット必要
  - 配置マッピング精緻化はバナナ/KIRYU判断待ち
