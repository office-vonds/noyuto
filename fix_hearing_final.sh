#!/bin/bash
# VONDSヒアリングシート — Gmail SMTP版（迷惑メール完全対策）
# メインPCで実行: bash ~/noyuto/fix_hearing_final.sh
...
echo "[1/2] Gmail SMTP版 send_hearing.php 作成完了"
...
echo "完了！"
echo "=========================================="
echo "Gmail SMTP経由で送信するため迷惑メールに入りません。"
